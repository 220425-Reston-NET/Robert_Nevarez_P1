...
builder.Services.AddScoped<IRepository<OrderHistory>, SQLOrderHistoryRepo>(repo => new SQLOrderHistoryRepo(Environment.GetEnvironmentVariable("Connection_String")));
