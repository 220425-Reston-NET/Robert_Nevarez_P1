...
namespace LeagueStoreUI
{
    ...
    //==============================================================================================
        ...
        public Jungle(IStoreItemsBL p_found)
        {
            _found = p_found;
        }
    //==============================================================================================
        ...
        {
            Console.Clear();
            Console.WriteLine ("=======Welcome to the Jungle Store!=======");
            Console.WriteLine ("You ready to just spam jungle diff in chat");
            Console.WriteLine ("What would you like to do today?");
            Console.WriteLine ("[2] - Buy Jungle Champion");
